/*
 * @lc app=leetcode.cn id=logical-or-of-two-binary-grids-represented-as-quad-trees lang=golang
 *
...
/*
 * func intersect(node1 *Node, node2 *Node) *Node {
 ...
 * 		br := intersect(node1.BottomRight, node2.BottomRight)
