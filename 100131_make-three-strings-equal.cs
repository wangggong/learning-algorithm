/*
 * @lc app=leetcode.cn id=make-three-strings-equal lang=csharp
 *
...
public class Solution
{
    ...
    {
        var (n1, n2, n3, k) = (s1.Length, s2.Length, s3.Length, 0);
        for (var n = Math.Min(n1, Math.Min(n2, n3));
            k < n && s1[k] == s2[k] && s1[k] == s3[k];
            k++) { }
        return k is 0 ? -1 : n1 + n2 + n3 - k * 3;
    }
}
