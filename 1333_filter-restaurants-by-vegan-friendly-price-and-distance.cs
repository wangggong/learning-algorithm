/*
 * @lc app=leetcode.cn id=filter-restaurants-by-vegan-friendly-price-and-distance lang=csharp
 *
...
{
    public IList<int> FilterRestaurants(int[][] restaurants, int veganFriendly, int maxPrice, int maxDistance) => restaurants
        .Select(r => (id: r[0], rating: r[1], veganFriendly: r[2], price: r[3], distance: r[4]))
        .Where(r => veganFriendly is 0 || r.veganFriendly is 1)
