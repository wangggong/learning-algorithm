/*
 * @lc app=leetcode.cn id=design-an-ordered-stream lang=golang
 *
...
func Constructor(n int) OrderedStream {
	return OrderedStream{Arr: make([]*string, n)}
}

func (o *OrderedStream) Insert(id int, v string) (ans []string) {
	o.Arr[id-1] = &v
	for ; o.Ptr < len(o.Arr) && o.Arr[o.Ptr] != nil; o.Ptr++ {
		ans = append(ans, *o.Arr[o.Ptr])
	}
	return
}
