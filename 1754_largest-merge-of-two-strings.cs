/*
 * @lc app=leetcode.cn id=largest-merge-of-two-strings lang=csharp
 *
...
public class Solution
{
    public string LargestMerge(string word1, string word2)
        => (word1.Length, word2.Length) switch
        {
            (0, _) => word2,
            (_, 0) => word1,
            _ => (word1.CompareTo(word2)) switch
            {
                < 0 => word2.Substring(0, 1) + LargestMerge(word1, word2.Substring(1)),
                _ => word1.Substring(0, 1) + LargestMerge(word1.Substring(1), word2),
            }
        };
}
