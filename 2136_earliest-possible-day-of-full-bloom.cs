/*
 * @lc app=leetcode.cn id=earliest-possible-day-of-full-bloom lang=csharp
 *
...
// 参考: https://leetcode.cn/problems/earliest-possible-day-of-full-bloom/solutions/1202113/quan-bu-kai-hua-de-zui-zao-yi-tian-by-le-ocxg
//
// 就这...
public class Solution
{
    ...
    {
        var (plantTime, growTime) = (0, 0);
        foreach (var (p, g) in plantTimes
            .Zip(growTimes)
            .OrderByDescending(x => x.Item2))
        {
            plantTime += p;
            growTime = Math.Max(growTime, plantTime + g);
        }
        return growTime;
    }
}
