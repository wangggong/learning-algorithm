/*
 * @lc app=leetcode.cn id=sort-the-students-by-their-kth-score lang=csharp
 *
...
public class Solution
{
    public int[][] SortTheStudents(int[][] score, int k)
    {
        ...
        var ans = new int[n][];
        var r = 0;
        foreach (var (i, _) in Enumerable.Range(0, n).Select(i => (i, score[i][k])).OrderByDescending(x => x.Item2))
        {
            ans[r] = score[i];
            r++;
        }
