/*
 * @lc app=leetcode.cn id=apply-bitwise-operations-to-make-strings-equal lang=csharp
 *
...
{
    public bool MakeStringsEqual(string s, string target) => !((target.Max() == '0') ^ (s.Max() == '0'));
}
