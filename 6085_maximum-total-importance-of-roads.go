/*
 * @lc app=leetcode.cn id=maximum-total-importance-of-roads lang=golang
 *
 * NOTE (beewangruichao): I cannot use fid, thus I use slug instead.
 *
 * [6085] 道路的最大总重要性
 *
 * https://leetcode-cn.com/problems/maximum-total-importance-of-roads/description/
 *
 * algorithms
 * Medium (55.11%)
 * Total Accepted:    3K
...
func maximumImportance(n int, roads [][]int) int64 {
	...
	sort.Slice(cnt, func(p, q int) bool { return cnt[p] > cnt[q] })
	ans := int64(0)
	for i, c := range cnt {
		ans += int64(c * (n - i))
	}
