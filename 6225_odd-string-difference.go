/*
 * @lc app=leetcode.cn id=odd-string-difference lang=golang
 *
...
func get(s string) (ans [100]int) {
	for i, n := 0, len(s); i+1 < n; i++ {
		ans[i] = int(s[i+1]-'a') - int(s[i]-'a')
	}
	return
}
