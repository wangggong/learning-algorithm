/*
 * @lc app=leetcode.cn id=lexicographically-smallest-string-after-substring-operation lang=csharp
 *
 ...
 * 
 * 
 * 选则 s 的任一非空子字符串，可能是整个字符串，接着将字符串中的每一个字符替换为英文字母表中的前一个字符。例如，'b' 用 'a' 替换，'a' 用
 * 'z' 替换。
 * 
 * 
