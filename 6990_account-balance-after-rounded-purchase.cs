/*
 * @lc app=leetcode.cn id=account-balance-after-rounded-purchase lang=csharp
 *
...
public class Solution
{
    ...
    public int AccountBalanceAfterPurchase(int purchaseAmount)
        => TotalAmount - new int[] { purchaseAmount / K * K, (purchaseAmount / K + 1) * K, }
            .OrderBy(x => Math.Abs(x - purchaseAmount))
            .ThenBy(x => -x)
            .First();
}
