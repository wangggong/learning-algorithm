/*
 * @lc app=leetcode.cn id=check-if-a-string-is-an-acronym-of-words lang=csharp
 *
...
{
    public bool IsAcronym(IList<string> words, string s) => new string(words.Select(w => w[0]).ToArray()) == s;
}
